...
USER="developer"
TARGET_DIR="/home/developer//microservices/user-service"
...
ssh $USER@$SERVER_IP "docker ps --filter name=user_microservice"

echo "İşlem Başarılı! user-service sorunsuz şekilde Docker üzerinde canlıya alındı."