...
USER="developer"
TARGET_DIR="/home/developer//microservices/payment-service"
...
ssh $USER@$SERVER_IP "docker ps --filter name=payment_microservice"

echo "İşlem Başarılı! payment-service sorunsuz şekilde Docker üzerinde canlıya alındı."